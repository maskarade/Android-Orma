...
public class AssociationConditionWriter extends BaseWriter {

    private final SchemaDefinition schema;

    private final ConditionQueryHelpers queryHelpers;

    public AssociationConditionWriter(ProcessingContext context, SchemaDefinition schema) {
        super(context);
        this.schema = schema;
    ...
    ClassName getTargetClassName() {
        return schema.getAssociationConditionClassName();
    }
    ...
    public TypeSpec buildTypeSpec() {
        ...
        classBuilder.superclass(Types.getAssociationCondition(schema.getModelClassName(), getTargetClassName()));

...
public abstract class AssociationCondition<Model, A extends AssociationCondition<Model, ?>>
    ...
    public AssociationCondition(@NonNull OrmaConnection connection) {
        super(connection);
    }
    ...
    public AssociationCondition(@NonNull AssociationCondition<Model, A> condition) {
        super(condition);
    }

    public abstract AssociationCondition<Model, A> clone();
    ...
    public <C extends OrmaConditionBase<?, ?>> C appendTo(C other) {
        String whereClause = getWhereClause();
        Object[] bindArgs = getBindArgs();

        if (whereClause != null && bindArgs != null) {
            other.where(whereClause, bindArgs);
        } else if (whereClause != null) {
            other.where(whereClause);
        }

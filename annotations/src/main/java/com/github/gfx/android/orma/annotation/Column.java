...
public @interface Column {
    ...
    @interface Helpers {
        ...
        long CONDITION_CONTAINS = CONDITION_NOT_IN << 1;
        long CONDITION_NOT_CONTAINS = CONDITION_CONTAINS << 1;

        long CONDITION_LT = CONDITION_NOT_CONTAINS << 1;
        ...
        long CONDITIONS = CONDITION_EQ | CONDITION_NOT_EQ | CONDITION_IS_NULL | CONDITION_IS_NOT_NULL
                | CONDITION_IN | CONDITION_NOT_IN | CONDITION_CONTAINS | CONDITION_NOT_CONTAINS

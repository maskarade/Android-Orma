...
```groovy
dependencies {
    compile 'com.github.gfx.android.orma:orma:3.2.0'
    apt 'com.github.gfx.android.orma:orma-processor:3.2.0'
}
```
...
A database handle, named `OrmaDatabase` by default, is generated by `orma-processor`,
...
Orma runtime is very lightweight: [Method Count for v3.2.0](http://www.methodscount.com/?lib=com.github.gfx.android.orma:orma:3.2.0)
...
dependencies {
    compile 'com.github.gfx.android.orma:orma:3.2.0'
    annotationProcessor 'com.github.gfx.android.orma:orma-processor:3.2.0'
}
```

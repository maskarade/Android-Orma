...
```gradle:build.gradle
dependencies {
    annotationProcessor 'com.github.maskarade.android.orma:orma-processor:5.1.1'
    compile 'com.github.maskarade.android.orma:orma:5.1.1'
}
```
...
```build.gradle
dependencies {
    compile 'com.github.maskarade.android.orma:orma-encryption:5.1.1'
}
```

...
```gradle:build.gradle
dependencies {
    annotationProcessor 'com.github.gfx.android.orma:orma-processor:4.2.1'
...
NOTE: **This is experimental in v4.2.1: its existence, signature or behavior might change without warning from one release to the next.**
...
as of Orma v4.2.1 and Realm 2.3.0, processing 10 items x 100 times:
...
Orma runtime is very lightweight: [Method Count for v4.2.1](http://www.methodscount.com/?lib=com.github.gfx.android.orma:orma:4.2.1)

...
```groovy
dependencies {
    apt 'com.github.gfx.android.orma:orma-processor:2.4.8'
...
Orma runtime is very lightweight: [Method Count for v2.4.8](http://www.methodscount.com/?lib=com.github.gfx.android.orma:orma:2.4.8)

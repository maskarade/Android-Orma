...
```gradle:build.gradle
dependencies {
    annotationProcessor 'com.github.gfx.android.orma:orma-processor:4.0.1'
    compile 'com.github.gfx.android.orma:orma:4.0.1'
}
```
...
NOTE: **This is experimental in v4.0.1: its existence, signature or behavior might change without warning from one release to the next.**
...
Orma runtime is very lightweight: [Method Count for v4.0.1](http://www.methodscount.com/?lib=com.github.gfx.android.orma:orma:4.0.1)

...
dependencies {
    ...
    apt 'com.github.gfx.android.orma:orma-processor:3.0.1'
}
```
...
Orma runtime is very lightweight: [Method Count for v3.0.1](http://www.methodscount.com/?lib=com.github.gfx.android.orma:orma:3.0.1)

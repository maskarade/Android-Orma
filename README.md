...
```groovy
dependencies {
    compile 'com.github.gfx.android.orma:orma:3.1.0'
    apt 'com.github.gfx.android.orma:orma-processor:3.1.0'
}
```
...
Orma runtime is very lightweight: [Method Count for v3.1.0](http://www.methodscount.com/?lib=com.github.gfx.android.orma:orma:3.1.0)
...
dependencies {
    compile 'com.github.gfx.android.orma:orma:3.1.0'
    annotationProcessor 'com.github.gfx.android.orma:orma-processor:3.1.0'
}
```

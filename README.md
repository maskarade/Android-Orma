...
```groovy
dependencies {
    compile 'com.github.gfx.android.orma:orma:3.2.2'
    apt 'com.github.gfx.android.orma:orma-processor:3.2.2'
}
```
...
Orma runtime is very lightweight: [Method Count for v3.2.2](http://www.methodscount.com/?lib=com.github.gfx.android.orma:orma:3.2.2)
...
dependencies {
    compile 'com.github.gfx.android.orma:orma:3.2.2'
    annotationProcessor 'com.github.gfx.android.orma:orma-processor:3.2.2'
}
```
